...
/// Jeffrey Wall's WebLog | MSDN Blogs > Jeffrey Wall's WebLog > Defrag API C# wrapper
///// 
...
namespace defraglib
{
    public class IOWrapper
    {
        ...
        static public Array GetFileMap(string path, out int errno)
        {
    ...
    */
                ...
                for (int i = 0; i < ExtentCount; i++)
                {
                    for (int j = 0; j < 2; j++)
                    {
                        ...
                        retVal.SetValue(v >> 32, new int[2] { i, j });
                        pDest = (IntPtr)((Int64)pDest + 8);
                    }
                }
