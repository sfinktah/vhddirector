        ...
        protected virtual bool RedrawBackgroundIfRequired(bool force = false)
        {
            ...
            else
            {
                ...
                if (this.GreenPartition_Left == null || hue != lastHue || saturation != lastSaturation || luminance != lastLuminance)
                {
                    ...
                    GreenPartition_Left = CSharpFilters.ColorSpace.Hue(VHD_Director.Properties.Resources.GreenPartition_Left, hue, saturation, luminance);
                    GreenPartition_Right = CSharpFilters.ColorSpace.Hue(VHD_Director.Properties.Resources.GreenPartition_Right, hue, saturation, luminance);
                    GreenPartition_Fill_Unused = CSharpFilters.ColorSpace.Hue(VHD_Director.Properties.Resources.GreenPartition_Fill_Unused, hue, saturation, luminance);
