...
namespace VHD_Director
{
    public partial class DiskUsageForm : Form
    {
        ...
        private void getWindowsVersionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Console.WriteLine("SystemVersionDll: {0}", SystemVersionInterop.GetText());
            // SystemVersionInterop.DisplayHelloFromDLL();
        }
