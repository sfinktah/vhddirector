    ...
    public partial class RotateWait : Form
    {
        ...
        public bool ShowProgress
        {
            ...
            set
            {
                ...
                {
                    showProgress = value;
                    blackProgressBar1.Visible = ShowProgress;
                }
            }
        }

        public BlackProgressBar Progress { get { return blackProgressBar1; } }
        public int Maximum { get { return Progress.Maximum; } set { Progress.Maximum = value; } }
        public int Minimum { get { return Progress.Minimum; } set { Progress.Minimum = value; } }
        public int Value
        {
            get { return Progress.Value; }
            set
            {
                if (value != Progress.Value) { Progress.Value = value; pictureBox1.BackColor = pictureBox1.BackColor; }
            }
        }

        public int Step { get { return Progress.Step; } set { Progress.Step = Step; } }
        ...
        public RotateWait()
        {
            ...
            pictureBox1.BackColorChanged += new EventHandler(pictureBox1_BackColorChanged);
        ...
        void pictureBox1_BackColorChanged(object sender, EventArgs e)
        {
            Rotate();
        }
        ...
        private void Rotate() {
            ...
            angle += 5;
            pictureBox1.Image = RotateImageByAngle(VhdDirectorApp.Properties.Resources.ring_48, angle);
            if (angle >= 360)
            {
                angle = 0;
            }
