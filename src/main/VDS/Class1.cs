...
namespace VDS
{
    ...
    //Got VD Provider
    //Got VDisks
    //-> VDisk Id=bfc33a5a-78bb-4146-972e-27bec179dac9
    ...
    public class LaurentEtiemble
    {
        static public Dictionary<string, string> example()
        {
            ...
            DebugConsole.WriteLine("Got Loader");

            // Load the service
            IVdsService service;
            loader.LoadService(null, out service);
            DebugConsole.WriteLine("Got Service");

            // Wait for readyness
            service.WaitForServiceReady();
            DebugConsole.WriteLine("Service is ready");
            ...
            DebugConsole.WriteLine("Got Providers");
            ...
            while (true)
            {
                ...
                DebugConsole.WriteLine("Got VD Provider");
...
#if USE_NON_MICROSOFT_VDS_INTEROP
